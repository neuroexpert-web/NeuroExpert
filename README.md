...
**NeuroExpert** - это современная платформа для цифровизации бизнеса с использованием искусственного интеллекта. Проект реализован как интерактивная презентация из 8 полноэкранных страниц с навигацией через свайпы.

### 🎯 Структура из 8 страниц:

1. **Главная** - Анимированная нейросеть и hero-секция
2. **Аналитика** - Интерактивные дашборды и метрики
3. **ROI-калькулятор** - Расчет экономической эффективности
4. **AI управляющий** - Демонстрация возможностей AI
5. **Решения** - Каталог услуг и продуктов
6. **Безопасность** - Защита данных и compliance
7. **Контакты** - Форма связи и CRM интеграция
8. **О нас** - Информация о компании
