...
**NeuroExpert** - это современная платформа для цифровизации бизнеса с использованием искусственного интеллекта. Проект реализован как интерактивная презентация из 10 полноэкранных страниц с навигацией через свайпы.

### 🎯 Структура из 10 страниц:

1. **Главная** - Анимированная нейросеть и hero-секция
2. **Аналитика** - Интерактивные дашборды и метрики  
3. **Аудитория** - Сегментация и анализ клиентов
4. **Процессы** - Автоматизация бизнес-процессов
5. **Решения** - Каталог услуг и продуктов
6. **Безопасность** - Защита данных и compliance
7. **О нас** - Информация о компании и команде
8. **Цены** - Калькулятор стоимости и тарифы
9. **Контакты** - Форма связи и CRM интеграция  
10. **Кабинет** - Визуальная студия и личный кабинет
