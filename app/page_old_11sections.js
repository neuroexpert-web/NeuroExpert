        ...
        <div className="hero-content">
          ...
          >
            ...
            <span className="button-content">
              ...
              <span className="cta-text">{loading ? 'Загрузка...' : 'Познакомиться с агентами'}</span>
...
<p>Искусственный интеллект изучил ваши данные и определил точки роста прибыли</p>
    ...
    // 11. Управление агентами
    <section key="agents" id="agents-section" className="full-page scrollable-section">
      <Suspense fallback={null}>
        <AgentList />
      </Suspense>
    </section>
