...
export const metadata = {
  ...
  openGraph: {
    title: 'NeuroExpert - Платформа автономных ИИ-агентов',
    description: 'Автономные ИИ-агенты работают для вас 24/7. Оплата через x402 - прозрачно и справедливо',
  ...
  twitter: {
    ...
    title: 'NeuroExpert - Автономные ИИ-агенты',
    description: 'Новая экономика ИИ-агентов. Платите за результат через протокол x402',
