...
export default function AIDirectorCapabilities() {
  ...
  const orchestratorData = {
    orchestrator: {
      ...
      icon: '🎯',
      content: {
        description: 'Умный помощник руководителя, который управляет всей командой экспертов',
        features: [
          'Помнит всё о вашем проекте',
          'Ставит задачи по важности',
          'Распределяет работу между экспертами',
          'Гарантирует прибыль в 3 раза больше вложений'
        ],
        process: [
          'Изучает вашу задачу',
          'Вспоминает всю историю проекта',
          'Определяет, что делать в первую очередь',
          'Контролирует работу команды',
          'Проверяет качество на всех этапах',
    ...
    agents: {
      ...
      content: {
        list: [
          { id: 'auditor', name: 'Аналитик', icon: '📊', role: 'Изучает ваш бизнес и находит возможности' },
          { id: 'strategist', name: 'Стратег', icon: '🎯', role: 'Планирует рост вашей прибыли' },
          { id: 'designer', name: 'Дизайнер', icon: '🎨', role: 'Создаёт красивый и удобный интерфейс' },
          { id: 'developer', name: 'Программист', icon: '👨‍💻', role: 'Воплощает идеи в рабочие решения' },
          { id: 'integrator', name: 'Технолог', icon: '🔗', role: 'Соединяет все системы воедино' },
          { id: 'pricer', name: 'Экономист', icon: '💰', role: 'Считает выгоду и стоимость' },
          { id: 'executor', name: 'Менеджер', icon: '⚡', role: 'Запускает проект и контролирует результат' }
        ]
      }
    },
    context: {
      ...
      icon: '🗄️',
      content: {
        description: 'Система, которая помнит абсолютно всё о вашем проекте',
        benefits: [
          'Ничего не забывает и не теряет',
          'Обновляется мгновенно',
          'Все эксперты знают одну и ту же информацию',
          'Сохраняет всю историю изменений'
        ]
      }
    },
    integrations: {
      title: 'Подключения к сервисам',
      icon: '🔌',
      content: {
        services: [
