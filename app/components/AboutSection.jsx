...
export default function AboutSection() {
  const teamMembers = [
    {
      name: 'Александр',
      role: 'Основатель',
      experience: 'AI-энтузиаст',
      avatar: '👨‍💼',
      description: 'Стратегия и развитие AI-решений'
    },
    {
      name: 'Екатерина',
      role: 'UX/UI дизайнер',
      ...
      avatar: '👩‍🎨',
      description: 'Создает удобные интерфейсы для AI'
    },
    {
      name: 'Степан',
      ...
      avatar: '👨‍💻',
      description: 'Внедряет AI в ваш бизнес'
    },
    {
      name: 'Алексей',
      ...
      avatar: '👨‍🔬',
      description: 'Измеряет эффективность AI'
    }
  ];
  ...
  const achievements = [
    ...
    { number: '150%+', text: 'Средний рост эффективности' }
  ];
