...
export default function EnhancedFloatingAI() {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      const greetings = {
        morning: "🌅 Доброе утро! Я Александр Нейронов, ваш AI-стратег NeuroExpert. Готов помочь превратить утренние идеи в миллионные проекты!",
        day: "⚡ Добрый день! Александр на связи. Лучшее время для принятия решений, которые изменят ваш бизнес навсегда!",
        evening: "🌙 Добрый вечер! Даже поздно - время для больших планов. Расскажите о вашем проекте мечты!"
      };
