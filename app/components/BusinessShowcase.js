  ...
  small: [
    {
      ...
      answer:
        "Да, особенно пакет 'Сайт с AI-экспертом' идеально подходит для eCommerce. AI поможет консультировать покупателей 24/7.",
    },
    {
  ...
  medium: [
    {
      ...
      answer:
        'BI-дашборды, интеграция всех систем, автоматические отчеты, прогнозирование и рекомендации на основе данных.',
    },
    {
      question: 'Как происходит интеграция с существующими системами?',
      answer:
        'Поэтапно, без остановки работы. Сначала анализируем архитектуру, затем создаем план миграции.',
    },
  ],
  large: [
    {
      ...
      answer:
        'Да, мы работаем с мультинациональными корпорациями. Решения адаптируются под различные юрисдикции.',
    },
    {
      question: 'Какие гарантии предоставляете?',
      answer:
        '12 месяцев гарантии, SLA 99.5%, техподдержка 24/7, возврат средств при невыполнении KPI.',
    },
  ],
};
...
function BusinessShowcase() {
  ...
  const createLead = (serviceData) => {
    ...
    alert(
      `Заявка на "${serviceData.title}" отправлена! Менеджер свяжется с вами в течение 2 часов.`
    );
  };
          ...
          {currentSegment.services.map((service) => (
            <div key={service.id} className="service-card">
              ...
              <div className="service-actions">
                <button className="cta-primary" onClick={() => createLead(service)}>
                  📞 Заказать услугу
                </button>
                <button className="cta-secondary" onClick={scrollToCalculator}>
                  💰 Рассчитать выгоду
                </button>
              </div>
            </div>
        ...
        <div className="package-faq">
          ...
          {showFAQ && (
            <div className="faq-content">
              ...
              <button className="calculate-benefit-btn" onClick={scrollToCalculator}>
