...
export default function SmartFloatingAI() {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      const greetings = {
        morning: "Доброе утро! ☀️ Александр Нейронов, управляющий дуправляющий NeuroExpert. Рад видеть вас так рано - это признак амбициозных людей! Чем могу помочь с вашим бизнесом?",
