...
**3 основателя** вместо 6 сотрудников:

1. **Александр Петров** - CEO & Founder
   - *10+ лет в IT, ex-Senior Developer в крупной IT-компании*
   - *Создал 3 успешных проекта автоматизации*

2. **Елена Иванова** - CTO & Co-founder  
   - *PhD в Computer Science, специалист по Machine Learning*
   - *Автор 15+ публикаций в области AI*

3. **Михаил Соколов** - Head of Product & Co-founder
   - *5+ лет в продуктовой разработке*
   - *Эксперт в UX для B2B-платформ*
